...
define(['creatartis-base', 'sermat', 'ludorum', 'ludorum-game-connect4'],
function (base, Sermat, ludorum, ludorum_game_connect4) {
	...
	describe("games.ConnectFour", function () {
		var game = new ludorum_game_connect4.ConnectFour(),
